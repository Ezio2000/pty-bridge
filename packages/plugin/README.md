...
The bundled `pty` skill teaches the host model to launch the returned command with Bash using `run_in_background=true` immediately after every `mcp__plugin_pty-bridge_pty__start` call.
